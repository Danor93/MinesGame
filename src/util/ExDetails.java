...
public class ExDetails {
	...
	public String toString() {
		return String.format("%s : %s %s, Email:%s", id, firstName, lastName, eMail);
	}
	...
	public static ExDetails firstStudent() {
		return new ExDetails("311156616", "Danor", "Sinai", "danor.sinai@e.braude.ac.il");
	}

	// Put the second student details here
	public static ExDetails secondStudent() {
		return new ExDetails("311285514", "Sahar", "oz", "sahar.oz@e.braude.ac.il");
